...
const Sidebar = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto overflow-x-hidden bg-gradient-to-b from-[#1a0033] via-[#0c0c5f] to-[#00334d] flex flex-col items-center px-4 sm:px-4 lg:px-16 py-6 text-white">
            {/* Blur circles */}
            ...
            <div className="relative flex flex-col items-center mb-4">
                <div className="p-0">
                    <img src={Image2} alt="Avatar" className="w-35 h-35 rounded-full object-contain" />
                </div>
