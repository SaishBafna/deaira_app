...
const FAQ = () => {
      ...
      questions: [
        {
          ...
          answer:
            "DeAIra is a decentralized platform that combines Web3 technology with artificial intelligence. It allows users to tokenize AI models as digital assets, deploy them on a decentralized network, and monetize them through a community-governed marketplace. The platform uses blockchain technology to ensure transparency and smart contracts to automate transactions and revenue sharing.",
        },
        {
          id: "gs2",
          question: "How do I create an account on DeAIra?",
          answer:
            "To use DeAIra, you simply need to connect a compatible Web3 wallet (like MetaMask or WalletConnect). No traditional account creation is required. For enhanced features, you may optionally verify your email address through our verification system.",
        },
        {
          id: "gs3",
          question: "What wallets are supported by DeAIra?",
          answer:
            "DeAIra supports all EVM-compatible wallets including MetaMask, WalletConnect, Coinbase Wallet, and Trust Wallet. We plan to expand support to additional wallets based on community demand.",
        },
      ],
    },
    {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Find answers to common questions about DeAIra, the decentralized AI
            platform
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Join the revolution in decentralized AI and start tokenizing your
            models today.
          </p>
  ...
  {/* Footer */}
  <footer className="relative z-10 mb-9">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="border-t border-white/10 mt-12 pt-8 text-center text-gray-400">
        <p className="mb-7">
          &copy; 2024 DeAIra. All rights reserved. Decentralizing AI for
          everyone.
        </p>
      </div>
    </div>
