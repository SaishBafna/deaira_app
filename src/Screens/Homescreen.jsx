...
import Image2 from '../assets/Images/homeimg.png';
import Profile from '../assets/Images/p.png';
import Image3 from '../assets/Images/panel3.png';
import Footer from '../Footer/Footer.jsx';
import R1 from '../assets/Images/homer1.png'; // Replace with your robot image path
const Homescreen = () => {
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-[#1a0033] via-[#0c0c5f] to-[#00334d] relative overflow-y-auto flex flex-col items-center px-4 sm:px-8 lg:px-16 py-6 gap-6">
      ...
      {/* First Tab Row */}
      <div className="w-full max-w-4xl flex rounded-xl overflow-hidden shadow-md">
      ...
      <div className="w-full max-w-4xl flex justify-between text-white font-semibold text-lg cursor-pointer">
      ...
      <div className="w-full max-w-4xl flex flex-nowrap items-center justify-center gap-4 sm:gap-6 p-4 sm:p-6 text-2xl font-bold text-center">
      ...
      {/* Token Info Card */}
      <div className="w-full max-w-4xl bg-gray-900 text-white rounded-2xl shadow-lg p-6 sm:p-8">
      ...
      {/* Token Detail Table */}
      <div className="w-full max-w-4xl bg-gradient-to-b from-[#43027a] to-[#1b1b3a] text-white rounded-2xl shadow-xl p-4 sm:p-6">
      ...
      <div className="flex items-center justify-between w-full max-w-md p-4 rounded-xl bg-gradient-to-r from-[#130628] to-[#2c0054] shadow-md mb-20">
        ...
        <div className="flex flex-col text-white ml-4 flex-1">
          <span className="font-semibold text-sm sm:text-base">Thrive with AI.</span>
          <span className="font-semibold text-sm sm:text-base">Grow with Community.</span>
        </div>
